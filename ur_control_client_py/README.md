...
클라이언트를 실행하기 전에 다음 노드들이 실행되어 있어야 합니다:
...
# Motion Action Server 실행 (planning group 자동 감지)
...
```bash
cd /ros2_ws/src/KETI_Universal_Robots_ROS2/ur_control_client_py/ur_control_client_py
touch my_program.py
